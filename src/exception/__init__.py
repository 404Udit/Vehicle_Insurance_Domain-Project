...
def error_message_detail(error:Exception,error_detail:sys) -> str:
    """
    Extracts detailed error information insluding file name, line number and the error message.
    ...
    # Log the error fro better tracking 
...
class MyException(Exception):
    """
    Custom exception class for handling errors in the Vehicle insurance domain application.
    """
    def __init__(self,error_message:str,error_detail:str):
        """
        Initializes the Vehicle_insurance_domain_Exception with a detailed error message.

        :param error_message: A string describing the error.
        :param error_detail: The sys module to access traceback details.
        """
        # Call the base class constructor with the error messaage
